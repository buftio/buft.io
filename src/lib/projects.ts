...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'yandex2023',
    name: 'Yandex',
    field: 'Hiring × workflow',
    role: 'Senior full-stack engineer',
    period: '2023–2024',
    title: 'From application to offer',
    summary: 'A system for managing candidates through the hiring process.',
    story:
      'I worked on the system recruiters used to manage candidates, from application to hiring. My work included vacancy publishing, search filters, and the candidate workflow.',
    details: [
      'Simplified vacancy publishing and candidate workflows.',
      'Worked on search filters and the candidate workflow.',
    ],
    color: '#ffd45b',
